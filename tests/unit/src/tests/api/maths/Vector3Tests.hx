...
class Vector3Tests extends BuddySuite
{
    public function new()
    {
        describe('Vector3', {
            ...
            describe('General', {
                it('Can set all three component values', {
                    var x = 12;
                    var y = 42.58;
                    var z = -32;
                ...
                it('Can copy all component values from another vector into itself', {
                    var v1 = new Vector3(12, 42.58, -32);
                    var v2 = new Vector3();
                ...
                it('Can create a string representation of the vector with all four components', {
                    var v = new Vector3(12, 42.58, -32);
                    v.toString().should.be(' { x : ${v.x}, y : ${v.y}, z : ${v.z} } ');
                });

                it('Can check if another vector contains the same component values', {
                    var v1 = new Vector3(12, 42.58, -32);
                    var v2 = new Vector3(12, 42.58, -32);
                    var v3 = new Vector3(12, 42.587, -32);
            ...
            describe('Maths', {
                it('Can calculate the dot product between it and another vector', {
                    var v1 = new Vector3(1, 2, 5);
                    var v2 = new Vector3(2, 4, 7);
                ...
                it('Can store the cross product between two other vectors', {
                    ...
                    var results = new Vector3().cross(v1, v2);
                ...
                it('Can invert its x, y, and z components', {
                    var v = new Vector3(3, 7.24, -15).invert();
                ...
                it('Can normalize its components', {
                    var v1 = new Vector3(3, 7.24, -15).normalize();
                    var v2 = new Vector3(3, 7.24, -15);
            ...
            describe('Operations', {
                it('Can add another vector instance', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(1, 4.5, -12);
                    var v3 = new Vector3(4, -2 , 8);
                ...
                it('Can add values to vector components', {
                    ...
                    var v1 = new Vector3(3, -5, 7.2);
                    var v2 = new Vector3(3, -5, 7.2);
            ...
            describe('Transformations', {
                it('Can transform itself by a matrix', {
                    ...
                    var v = new Vector3(x, y, z).transform(m);
                ...
                it('Can set itself to the euler angle from a quaternion', {
                    var q = new Quaternion().setFromAxisAngle(new Vector3(1, 0, 1), Maths.toRadians(45));
                    var v = new Vector3().setEulerFromQuaternion(q);
            ...
            describe('Static Creators', {
                it('Can add two vectors together and store the result in a new Vector3', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(4, -2 , 8);
                    var rs = Vector3.Add(v1, v2);
                ...
                it('Can subtract two vectors together and store the result in a new Vector3', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(4, -2 , 8);
                    var rs = Vector3.Subtract(v1, v2);
                ...
                it('Can multiply two vectors together and store the result in a new Vector3', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(4, -2 , 8);
                    var rs = Vector3.Multiply(v1, v2);
                ...
                it('Can divide two vectors together and store the result in a new Vector3', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(4, -2 , 8);
                    var rs = Vector3.Divide(v1, v2);
                ...
                it('Can add a scalar to a vector and store the result in a new Vector3', {
                    var v = new Vector3(1, 4.5, -12);
                    var s = 24.7;
                    var r = Vector3.AddScalar(v, s);
                ...
                it('Can subtract a scalar from a vector and store the result in a new Vector3', {
                    var v = new Vector3(1, 4.5, -12);
                    var s = 24.7;
                    var r = Vector3.SubtractScalar(v, s);
                ...
                it('Can multiply a vector by a scalar and store the result in a new Vector3', {
                    var v = new Vector3(1, 4.5, -12);
                    var s = 24.7;
                    var r = Vector3.MultiplyScalar(v, s);
                ...
                it('Can divide a vector by a scalar and store the result in a new Vector3', {
                    var v = new Vector3(1, 4.5, -12);
                    var s = 24.7;
                    var r = Vector3.DivideScalar(v, s);
                ...
                it('Can calculate the cross product of two vectors and store the result in a new Vector3', {
                    var v1 = new Vector3(1, 4.5, -12);
                    var v2 = new Vector3(4, -2 , 8);
                    var rs = Vector3.Cross(v1, v2);
            ...
            describe('Observing change', {
                ...
                it('allows subscribing to the vector3', {
                    vector.subscribe(new Observer(_ -> count++, null, null));
                });

                it('will tick a unit value when the vector3 changes', {
                    vector.set(1, 2, 3);
