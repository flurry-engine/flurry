    ...
    public function new()
    {
        describe('SAT2DTests', {
            it('can test between a circle and a polygon', {
                ...
                SAT2D.testCircleVsPolygon(s1, s2, result).should.be(true);
                ...
                SAT2D.testCircleVsPolygon(s1, s2).should.be(false);
            });
            ...
            it('can test between two circles', {
                ...
                var result = new ShapeCollision();
                SAT2D.testCircleVsCircle(c1, c2, result).should.be(true);
                ...
                SAT2D.testCircleVsCircle(c1, c2, result).should.be(false);
            });
            ...
            it('can test bewtween two polygons', {
                ...
                var result = new ShapeCollision();
                SAT2D.testPolygonVsPolygon(p1, p2, result).should.be(true);
            ...
            it('can test between a ray and a circle', {
                ...
                SAT2D.testRayVsCircle(r, c, result).should.be(true);
            ...
            it('can test between a ray and a polygon', {
                ...
                var result = new RayCollision();
                SAT2D.testRayVsPolygon(r, p, result).should.be(true);
