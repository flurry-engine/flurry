...
class Page
{
    ...
    public function pack(_request : PackRequest, _width, _height)
    {
        ...
        {
            final frame = new Frame(rect, _request, xPad, yPad);
            ...
            new PackedAsset(name, _request, xSrc, ySrc, _width, _height, u1, v1, u2, v2);
        }
    }
}